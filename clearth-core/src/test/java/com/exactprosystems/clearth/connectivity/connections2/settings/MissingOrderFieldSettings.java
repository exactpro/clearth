...
public class MissingOrderFieldSettings extends ClearThConnectionSettings<MissingOrderFieldSettings>
{
	@ConnectionSetting
	...
	@Override
	public MissingOrderFieldSettings copy()
	{
		MissingOrderFieldSettings result = new MissingOrderFieldSettings();
		result.login = login;
