...
public class MissingColumnSettings extends ClearThConnectionSettings<MissingColumnSettings>
{
	@ConnectionSetting
	private String host;
	...
	@Override
	public MissingColumnSettings copy()
	{
		MissingColumnSettings result = new MissingColumnSettings();
		result.host = host;
		result.port = port;
		result.login = login;
		return result;
