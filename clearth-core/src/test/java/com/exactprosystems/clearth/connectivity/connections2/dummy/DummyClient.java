...
import com.exactprosystems.clearth.connectivity.connections2.clients.BasicClearThClient;
import com.exactprosystems.clearth.connectivity.connections2.clients.MessageReceiverThread;
...
public class DummyClient extends BasicClearThClient
{
	...
	public DummyClient(DummyMessageConnection owner) throws ConnectionException, SettingsException
	{
		super(owner);
	}
