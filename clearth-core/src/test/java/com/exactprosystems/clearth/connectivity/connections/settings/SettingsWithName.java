...
public class SettingsWithName implements ClearThConnectionSettings
{
	@ConnectionSetting
	private String host;
	...
	{
		SettingsWithName settingsWithNameFrom = (SettingsWithName) settingsFrom;

		this.host = settingsWithNameFrom.host;
		this.port = settingsWithNameFrom.port;
		this.Name = settingsWithNameFrom.Name;
		this.password = settingsWithNameFrom.password;
	}
