...
public class MatrixFileExtensions
{
	private static final Set<String> supportedExtensions;
	public static final String supportedExtensionsAsString;
	...
	static {
		...
		supportedExtensionsAsString = String.join(", ", supportedExtensions);
	}

	public static boolean isExtensionSupported(String extension)
	{
		return supportedExtensions.contains(extension.toLowerCase().replace(".",""));
	}
}
