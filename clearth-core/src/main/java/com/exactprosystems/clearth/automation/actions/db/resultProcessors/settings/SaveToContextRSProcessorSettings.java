...
public class SaveToContextRSProcessorSettings extends ResultSetProcessorSettings
{
	protected Map<String, Object> mvelVars;

	public SaveToContextRSProcessorSettings()
	{
	}
