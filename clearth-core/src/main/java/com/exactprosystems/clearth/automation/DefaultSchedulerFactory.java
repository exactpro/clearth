...
{
	public DefaultSchedulerFactory(ExecutorFactory executorFactory, StepFactory stepFactory)
	{
		super(executorFactory, stepFactory);
	}
	...
	{
		return new DefaultScheduler(name, configsRoot, schedulerDirName, executorFactory, stepFactory);
	}
