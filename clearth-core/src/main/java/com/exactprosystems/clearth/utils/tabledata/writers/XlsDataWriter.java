...
public class XlsDataWriter extends AbstractExcelDataWriter
{
	public XlsDataWriter(TableHeader<String> header, File f, String sheetName, boolean appendSheet,  boolean needHeader, boolean appendFile) 
	...
	public static void write(StringTableData table, File f, String sheetName, boolean appendSheet,  boolean needHeader, boolean appendFile) 
			throws IOException, InvalidFormatException
	{
		XlsDataWriter writer = null;
		try
		{
			writer = new XlsDataWriter(table.getHeader(), f, sheetName, appendSheet, needHeader, appendFile);
