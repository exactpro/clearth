...
public class ClearThCallableStatement extends ClearThPreparedStatement implements CallableStatement
{
	private CallableStatement callableStatement;

	public ClearThCallableStatement(CallableStatement callableStatement, GlobalContext globalContext)
	{
		super(callableStatement, globalContext);
