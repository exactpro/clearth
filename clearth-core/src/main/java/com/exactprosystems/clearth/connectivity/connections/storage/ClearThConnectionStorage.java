...
{
	void registerType(ConnectionTypeInfo info) throws SettingsException, ConnectivityException;
	...
	ConnectionTypeInfo getConnectionTypeInfo(String type) throws ConnectivityException;
