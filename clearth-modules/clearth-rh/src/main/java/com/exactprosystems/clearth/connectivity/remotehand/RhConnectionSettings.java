...
public class RhConnectionSettings implements ClearThConnectionSettings
{
	@XmlElement
	...
	{
		RhConnectionSettings rhSettings = (RhConnectionSettings)other;
		this.url = rhSettings.getUrl();
	}
